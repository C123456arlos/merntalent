...
const StatsCards = ({activeSessionsCount, recentSessionsCount}) => {
  return (
      <div className="lg:col-span-1 grid grid-cols-1 gap-6">
        <div className="card bg-base-100 border-primary/20 hover:border-primary/40">
          <div className="card-body">
            <div className="flex items-center justify-between mb-3">
              <div className="p-3 bg-primary/10 rounded-2xl">
                <UserIcon className="w-7 h-7 text-primary"></UserIcon>
              </div>
      ...
      <div className="card-body">
        <div className="flex items-center justify-between mb-3">
          <div className="p-3 bg-secondary/10 rounded-2xl">
            <TrophyIcon className="w-7 h-7 text-secondary"></TrophyIcon>
          </div>
        </div>
